  ...
  <div id="section-form" class="section-form section-form--confirm">
    <div class="pageTitle">
      <div class="headingWrap">
        <h2 class="headingNormal">プライバシーポリシー</h2>
        <p class="text">内容をよくお読みください。</p>
      </div>
    </div>

    <div class="container--xl">
      <p class="privacy-introduction">
      株式会社MOSQIIIT（以下、「当社」という）では、当社の運営するFIVE G TOKYOをご利用頂くお客様の個人情報を適切に保護するため、その取扱いにつきましては細心の注意を払っております。
      </p>
      <div class="SCT__item">
      ...
      <div class="SCT__item">
        ...
        <p>2-3.個人情報を特定の者との間で共同して利用する場合であって，その旨並びに共同して利用される個人情報の項目，共同して利用する者の範囲，利用する者の利用目的および当該個人情報の管理について責任を有する者の氏名または名称について，あらかじめ本人に通知し，または本人が容易に知り得る状態に置いた場合</p>
      </div>
      <div class="SCT__item">
        ...
        <p>1-1.本人または第三者の生命，身体，財産その他の権利利益を害するおそれがある場合</p>
      ...
      <div class="SCT__item">
        ...
        <p>住所：〒170-0012　東京都豊島区上池袋２丁目２６−１２</p>
        <p>社名：株式会社MOSQIIIT</p>
        <p>担当部署：総務</p>
